                                ...
                                <div class="box-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <!-- /.direct-chat-info -->
                                            <img class="direct-chat-img" src="/public/images/user1-128x128.jpg"
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-info -->
                                            <img class="direct-chat-img" src="/public/images/user3-128x128.jpg"
                                                 alt="message user image">
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="/public/images/user1-128x128.jpg" alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/28/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="/public/images/user7-128x128.jpg" alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/23/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="/public/images/user3-128x128.jpg" alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/20/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="/public/images/user5-128x128.jpg" alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/10/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="/public/images/user6-128x128.jpg" alt="User Image">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">1/27/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="/public/images/user8-128x128.jpg" alt="User Image">
