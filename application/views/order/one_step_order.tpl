<div class="one-steporder-form">
	...
	<div style="width: 390px; height: 350px;" class="" id="element_1">
		...
		<div style="" class="BoxFastOrder">
			...
			<form id="fast-order" method="post" action="/ajax/one_step_order/">
				...
				<input type="hidden" name="good_stock_id" value="{$good_stock_id}" />
					...
					<li>
	                    <div class="field">
	                        <label for="email_address " class="required BoxFastOrderLabel">Email<em>*</em></label>
	                        <div class="input-box">
	                ...
	                <li>
	                    <div class="field">
	                        ...
	                        <div class="input-box">
	                        	<textarea name="comment" class="input-long-text"></textarea>
	                        </div>
	                    </div>
	                </li>
	                <li>
