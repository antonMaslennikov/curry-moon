<div style="padding:0px;margin:0px;font-family:arial;font-size:13px;">
	<div style="width:681px;background-color:#cccccc;">
		<table border="0" cellpadding="0" cellspacing="0" height="33" width="100%" style="margin:0;">
			<tbody>
				<tr>
					<td style="padding-right:27px;" align="right"><span style="font-size:12px;">Комментарий к работе "<?= $goodName ?>"</span></td>										
				</tr>
			</tbody>
		</table>
				...
				<tbody>
					<tr>
						<td style="font-size:0;padding-left:8px;" width="111" valign="top" align="left">
							<a href="http://www.maryjane.ru" style="border:0px;margin:0px;padding:0px;" target="_blank"><img src="http://www.maryjane.ru/images/mt/logo2013.jpg" width="70" height="80" alt="" title="" style="border:0;margin:0;padding:0;" /></a>
						</td>
						<td align="left">
							<br/>
							<span style="color:#4f4f4f;font-size:19px;">Здравствуйте, %userNameLogin%!</span><br/><br/>
							<span style="color:#4f4f4f;font-size:19px;">Вы получили это сообщение потому, что подписаны на новые комментарии  к работе «<a href="%quickLoginLink%&next=<?= $link ?>" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank"><?= $goodName ?></a>»</span>
							<br/><br/>								
							<table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0;">
								<tbody>
									<tr>
										<td width="54" valign="top" align="left">
											<img src="http://www.maryjane.ru/<?= $user_avatar ?>" width="54" height="54" alt="" title="" style="border:0px;margin:0px;padding:0px;">
										</td>
										<td width="22" valign="top" align="left">
										</td>
										<td valign="top" align="left">
											<span style="color:#979797;font-size:17px;"><?= $date ?><br/><?= $user_login ?><br/><br/><?= $comment ?></span>
							...
							<br/><br/>
							<a href="%quickLoginLink%&next=<?= $link ?>" style="font-size:18px;color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">Ответить</a>
							<br/><br/>
							<a href="%quickLoginLink%&next=<?= $link ?>" style="border:0px;margin:0px;padding:0px;" target="_blank"><img src="http://www.maryjane.ru/images/mt/455/work.jpg" width="320" height="235" alt="misc" title="" style="border:0px;margin:0px;padding:0px;"></a>
							
							<br/><br/><br/>
							<span style="color:#979797;font-size:13px;">Чтобы больше <a href="http://www.maryjane.ru/unsubscribe/<?= $userId ?>/%unsubscribeCode%/good/<?= $good_id ?>/" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">не получать уведомения о новых комментариях к этой работе</a>,<br/> или снимите галочку «Подписаться на комментарии» в ветке темы.<br/>Отписаться от всех уведомлений «<a href="%quickLoginLink%&next=http://www.maryjane.ru/profile/" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">Профиль > Редактировать данные</a>».</span><br/>							
						</td>
					</tr>
				</tbody>
			</table>
