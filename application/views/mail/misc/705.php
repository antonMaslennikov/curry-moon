			...
			<table border="0" cellpadding="0" cellspacing="0" width="645" style="margin:0;">
				<tbody>
					<tr>
						...
						<td align="left">
						Спасибо, что выбрали Maryjane.ru! Делая покупки с нами вы поддерживаете независимых авторов, мы всегда предлагаем огромный выбор дизайнерских принтов на носителях лучшего качества.<br>
...
<br/>
							<br/>
							Ваш логин  <?= $user_email ?><br/>
							<?= ($user_password) ? 'Ваш пароль <b>' . $user_password . '</b>' : '' ?>.<br/><br/>
							<span style="color:#4f4f4f;font-size:19px;line-height:22px;">Пожалуйста, подтвердите Ваш e-mail<br/> <a href="http://www.maryjane.ru/registration/activate/?userid=<?= $user_id ?>&key=<?= $code ?>" style="border:0px;margin:0px;padding:0px;" target="_blank">Подтвердить e-mail</a>. <br/>
							</span>
							<br/>							
							<a href="http://www.maryjane.ru/registration/activate/?userid=<?= $user_id ?>&key=<?= $code ?>" style="border:0px;margin:0px;padding:0px;" target="_blank"><img src="http://www.maryjane.ru/images/mt/453/activate.jpg" width="318" height="234" alt="" title="" style="border:0px;margin:0px;padding:0px;"></a>
							<br/><br/>							
							<span style="color:#979797;font-size:15px;">Или скопируйте эту ссылку</span><br/>				
							<a href="http://www.maryjane.ru/registration/activate/?userid=<?= $user_id ?>&key=<?= $code ?>" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">http://www.maryjane.ru/registration/activate/?userid=<?= $user_id ?>&key=<?= $code ?></a>
