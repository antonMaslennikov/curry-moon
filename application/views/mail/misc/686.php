				...
				<tr>
					...
					<td align="left" style="color:#4a4a4a;">
						...
						<span style="font-size: 14px;">
							ЗАДАНИЕ НА ПОЕЗДКУ НА <?= datefromdb2textdate($order->logs['deliverydate'][0]['result'], 3) ?>
						</span>
						...
						<span style="font-size: 14px;">
							ЦЕЛЬ:<br/>
							<b><?= $order->logs['delivery_order'][0]['result'] ?></b>
						</span>
						...
						<span style="font-size: 14px;">
						ОТЧИСЛЕНИЕ КУРЬЕРУ: <?= $order->user_basket_delivery_boy_cost ?> руб.
						</span>
