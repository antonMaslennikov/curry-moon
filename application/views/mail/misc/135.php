		...
		<table border="0" cellpadding="0" cellspacing="0" width="645" style="margin:0;">
			<tbody>
				<tr>
					...
					<td align="left">
						<br/>
						<span style="color:#4f4f4f;font-size:19px;">Здравствуйте!</span>
						<br/><br/>
						<span style="color:#4f4f4f;font-size:19px;">Вы отправили запрос на изменение почтового ящика.</span>			
						<br/><br/>							
						<a href="<?= $confirmLink ?>" style="border:0;margin:0;padding:0;" target="_blank"><img src="http://www.maryjane.ru/images/mt/135/email.jpg" width="321" height="235" style="border:0;margin:0;padding:0;"></a>
						<br/><br/>						
						<span style="color:#979797;font-size:17px;word-break:break-word;">Чтобы измененить email на новый: <?= $changeTo ?>, пройдите  по ссылке <a href="<?= $confirmLink ?>" style="color:#3697da;border:0;margin:0;padding:0;" target="_blank"><?= $confirmLink ?></a></span>
						<br/><br/>
						<span style="color:#979797;font-size:12px;">Ссылка действительна, в течении 3 часов с момента получения этого письма</span>
						<br/><br/>
						<span style="color:#979797;font-size:15px;">Если Вы не отправляли никакого запроса на изменение почты,<br/>пожалуйста, не предпринимайте никаких действий!</span>						
					</td>
				</tr>
			</tbody>
		</table>
