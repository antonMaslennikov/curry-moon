			...
			<table border="0" cellpadding="0" cellspacing="0" width="645" style="margin:0;">
				<tbody>
					<tr>
						...
						<td align="left">
							<br/>
							<span style="color:#4f4f4f;font-size:19px;line-height:22px;">Поздравляем, Вы прошли регистрацию,<br/>требуется <a href="http://www.maryjane.ru/registration/activate/?userid=<?= $user_id ?>&key=<?= $code ?>" style="border:0px;margin:0px;padding:0px;" target="_blank">активация</a>. После Вы сможете изменить<br/>присвоенный Вам пароль <?= ($user_password) ? '<b>' . $user_password . '</b>' : '' ?>.</span>
							<br/><br/>							
