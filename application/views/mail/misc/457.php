<div style="padding:0px;margin:0px;font-family:arial;font-size:13px;">
    <div style="width:681px;background-color:#cccccc;">
        <table border="0" cellpadding="0" cellspacing="0" height="33" width="100%" style="margin:0;">
            <tbody>
                <tr>
                    <td style="padding-right:27px;" align="right"><span style="font-size:12px;">%userBonusesText%</span></td>
                </tr>
            </tbody>
        </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="645" style="margin:0;">
                <tbody>
                    <tr>
                        ...
                        <td align="left">
                            <br/>
                            <span style="color:#4f4f4f;font-size:17px;">Поздравляем Вас - Ваша регистрация успешно подтверждена.</span>
                            <br/><br/>                          
                            <a href="%quickLoginLink%&amp;next=http://www.maryjane.ru" style="border:0px;margin:0px;padding:0px;" target="_blank"><img src="http://www.maryjane.ru/images/mt/457/welcome.jpg" width="320" height="234" alt="" title="" style="border:0px;margin:0px;padding:0px;"></a>
                            <br/><br/>
                            <span style="color:#979797;font-size:15px;">Прямо сейчас Вы можете <a href="%quickLoginLink%&amp;next=http://www.maryjane.ru" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">зайти на сайт</a>, <a href="%quickLoginLink%&amp;next=http://www.maryjane.ru/senddrawing.design/">присылать работы</a> и накапливать бонусы за покупки.</span>
                            <br/><br/>
                            <span style="color:#979797;font-size:15px;">Теперь Вы можете: </span>
                            <br/><br/>
                            <span style="color:#979797;font-size:15px;">&mdash;&nbsp;<a href="http://www.maryjane.ru/voting/competition/main/">голосовать за новые работы</a>,</span><br/>
                            <span style="color:#979797;font-size:15px;">&mdash;&nbsp;<a href="http://www.maryjane.ru/senddrawing.design/">присылать собственные работы</a>,</span><br/>
                            <span style="color:#979797;font-size:15px;">&mdash;&nbsp;<a href="%quickLoginLink%&amp;next=http://www.maryjane.ru/profile/" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">уточнить свои данные в профиле</a>,</span><br/>
                            <span style="color:#979797;font-size:15px;">&mdash;&nbsp;изменить присвоенный логин (только для быстрой регистрации), </span><br/>
                            <span style="color:#979797;font-size:15px;">&mdash;&nbsp;накапливать скидку в виде бонусов за заказ, от 5% до 20%!,</span><br/>
                            <span style="color:#979797;font-size:15px;">&mdash;&nbsp; размещать фотографии,</span><br/>
                            <span style="color:#979797;font-size:15px;">&mdash;&nbsp; добавлять комментарии,</span><br/>
                            <span style="color:#979797;font-size:15px;">&mdash;&nbsp;   публиковать посты в блоге,</span><br/>
                            <span style="color:#979797;font-size:15px;">&mdash;&nbsp;  участвовать в партнерской программе,</span><br/>
                            <span style="color:#979797;font-size:15px;">&mdash;&nbsp;   и, наконец, приобретать эксклюзивные продукты!</span>
                            <br/><br/>
                            <span style="color:#4f4f4f;font-size:19px;line-height:22px;">Внимание! Пожалуйста сохраните логин и пароль.</span>                          
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div style="width:100%;margin:0;padding:30px 0 0 0;">
            ...
            <div align="left" style="padding-left:30px;">
                ...
                <br/><span style="color:#666;">КАЖДЫЙ ДЕНЬ - НОВЫЙ ДИЗАЙН, ПОТОМУ ЧТО КАЖДЫЙ ДЕНЬ - НОВЫЙ.</span><br/>
