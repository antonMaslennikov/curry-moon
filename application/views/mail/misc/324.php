			...
			<tbody>
				<tr>
					...
					<td align="left">
						...
						<br/><br/>
						<span style="color:#4f4f4f;font-size:19px;">Ответ менеджера  </span>			
						<br/><br/>							
						<a href="#" style="border:0px;margin:0px;padding:0px;" target="_blank"><img src="http://www.maryjane.ru/images/mt/324/chat.jpg" width="316" height="233" alt="" title="" style="border:0px;margin:0px;padding:0px;"></a>
						<br/><br/>
							...
							<tbody>
								<tr>
									...
									<td valign="top" align="left">
										<span style="color:#979797;font-size:17px;">менеджер <?= $user_login ?><br/><?= $date ?><br/><br/><?= $replay ?></span>
									</td>										
								</tr>
							</tbody>
						</table>
						<br/><br/><br/>
						<span style="color:#979797;font-size:15px;">Просмотреть всю переписку <a href="http://www.maryjane.ru<?= $link ?>" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">тут</a></span>						
					</td>
				</tr>
			</tbody>
		</table>
