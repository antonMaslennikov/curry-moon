<div style="padding:0px;margin:0px;font-family:arial;font-size:13px;">
	<div style="width:681px;background-color:#cccccc;">
		<table border="0" cellpadding="0" cellspacing="0" height="33" width="100%" style="margin:0;">
			<tbody>
				<tr>
					<td style="padding-right:27px;" align="right"><span style="font-size:12px;"> </span></td>
				</tr>
			</tbody>
		</table>
				...
				<tbody>
					<tr>
						<td style="font-size:0;padding-left:8px;" width="111" valign="top" align="left">
							<a href="http://www.allskins.ru" style="border:0px;margin:0px;padding:0px;" target="_blank"></a>
						</td>
						<td align="left">
						Спасибо, что выбрали Allskins.ru! Делая покупки с нами вы поддерживаете независимых авторов, мы всегда предлагаем огромный выбор дизайнерских принтов на носителях лучшего качества.<br>
Дарим Вам скидку 300 рублей на первую покупку, при заказе от 3000 рублей. Скидка пересчитается автоматически при добавлении товара в корзину на сумму 3000 рублей.<br>
Оцените все наши преимущества, сделайте покупку прямо сейчас!  
<br/>
							<br/>
							Ваш логин  <?= $user_login ?><br/>
							<?= ($user_password) ? 'Ваш пароль <b>' . $user_password . '</b>' : '' ?>.<br/><br/>
							<span style="color:#4f4f4f;font-size:19px;line-height:22px;">Пожалуйста, подтвердите Ваш e-mail<br/> <a href="http://www.allskins.ru/registration/activate/?userid=<?= $user_id ?>&key=<?= $code ?>" style="border:0px;margin:0px;padding:0px;" target="_blank">Подтвердить e-mail</a>. <br/>
							</span>
							<!--br/>							
							<a href="http://www.allskins.ru/registration/activate/?userid=<?= $user_id ?>&key=<?= $code ?>" style="border:0px;margin:0px;padding:0px;" target="_blank"><img src="http://www.allskins.ru/images/mt/453/activate.jpg" width="318" height="234" alt="" title="" style="border:0px;margin:0px;padding:0px;"></a-->
							<br/><br/>							
							<span style="color:#979797;font-size:15px;">Или скопируйте эту ссылку</span><br/>				
							<a href="http://www.allskins.ru/registration/activate/?userid=<?= $user_id ?>&key=<?= $code ?>" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">http://www.allskins.ru/registration/activate/?userid=<?= $user_id ?>&key=<?= $code ?></a>
							
							<br/><br/>	
							<span style="color:#979797;font-size:15px;">Активация аккаунта, позволит Вам следить за ходом Ваших заказов,<br/>получать скидки, хранить историю заказов, получать самые<br/>свежие новости - сейчас это невозможно, еcли Вы вышли с сайта.</span>							
						</td>
					</tr>
				</tbody>
			</table>
