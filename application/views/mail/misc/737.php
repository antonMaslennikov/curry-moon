<p>Отчёт составлен за позапрошлый месяц. Оптовые заказы</p>

<p><a href="http://www.maryjane.ru/index_admin.php?module=admin_orderstats&action=paymenttype&wholesale=only">http://www.maryjane.ru/index_admin.php?module=admin_orderstats&action=paymenttype&wholesale=only</a></p>
