<div style="width:681px;background-color:#cccccc;padding:0;margin:0;font-family:arial;font-size:13px">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="645" style="margin:0">
			<tbody>
				<tr>
					...
					<td align="left">
						<br/>
						<span style="color:#4f4f4f;font-size:19px;">Здравствуйте, %userNameLogin%!</span>
						<br/><br/>
						<span style="color:#4f4f4f;font-size:19px;">Вам пришло новое сообщение от пользователя:</span>			
						<br/><br/>						
						<table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0;">
							<tbody>
								<tr>
									<td width="54" valign="top" align="left">
										<img src="http://www.maryjane.ru/<?= $user_avatar ?>" width="54" height="54" alt="" title="" style="border:0;margin:0;padding:0;">
									</td>
									<td width="22" valign="top" align="left">
									</td>
									<td valign="top" align="left">
										<span style="color:#979797;font-size:17px;"><?= $user_login ?><br/><?= $date ?><br/><br/><?= $replay ?></span>
									</td>										
								</tr>
							</tbody>
						</table>
						<br/><br/>
						<a href="http://www.maryjane.ru/messages/view/<?= $message_id ?>" style="border:0;margin:0;padding:0;" target="_blank"><img src="http://www.maryjane.ru/images/mt/178/msg_user.jpg" width="317" height="234" alt="Вам пришло новое сообщение" title="Вам пришло новое сообщение" style="border:0;margin:0;padding:0"></a>
						<br/><br/><br/>
						<? if ($referer): ?>
						<p>Со страницы: <?= $referer ?></p>
						<? endif; ?>
						<span style="color:#979797;font-size:17px;">Чтобы прочитать всю переписку перейдите по ссылке:</span><br/>
						<a href="http://www.maryjane.ru/messages/view/<?= $message_id ?>/" style="font-size:17px;color:#3697da;border:0;margin:0;padding:0;" target="_blank">http://www.maryjane.ru/messages/view/<?= $message_id ?>/</a>
						<br/><br/>
						<span style="color:#979797;font-size:12px;">Если указанная выше ссылка не открывается, скопируйте ее в буфер обмена,<br/> вставьте в адресную строку браузера и нажмите ввод.</span>
						<br/><br/>
						<span style="color:#979797;font-size:12px;">Вы получили это письмо, потому что зарегистрированы на сайте <a href="http://www.maryjane.ru" style="color:#3697da;border:0;margin:0;padding:0;" target="_blank">maryjane.ru</a></span><br/><br/>					
						<span style="color:#979797;font-size:12px;">Вы можете настроить отправку уведомлений о новых личных сообщениях<br/>в разделе <a href="http://www.maryjane.ru/editprofile/" style="color:#3697da;border:0;margin:0;padding:0;" target="_blank">Профиль > Редактировать данные.</a></span>
					</td>
				</tr>
			</tbody>
		</table>
	...
	<div style="width:100%;margin:0;padding:30px 0 0 0;">
		...
		<div align="left" style="padding-left:30px;">
			<div><span style="color:#666;">Вы всегда можете&nbsp;</span><a href="http://www.maryjane.ru/unsubscribe/%userId%/%unsubscribeCode%/" style="color:#2f98ce;" target="_blank">отписаться</a></div>
