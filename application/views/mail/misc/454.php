			...
			<table border="0" cellpadding="0" cellspacing="0" width="645" style="margin:0;">
				<tbody>
					<tr>
						...
						<td align="left">
							<br/>
							<span style="color:#4f4f4f;font-size:19px;line-height:22px;">Здравствуйте, %userNameLogin%!</span><br/><br/>
							<span style="color:#4f4f4f;font-size:19px;line-height:22px;">Вы получили это сообщение потому что следите за комментариями к теме «<a href="<?= $link2 ?>" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank"><?= $newsSubject ?></a>» на сайте Maryjane.ru</span>
							<br/><br/>	
							<a href="<?= $link2 ?>" style="border:0px;margin:0px;padding:0px;" target="_blank"><img src="http://www.maryjane.ru/images/mt/454/smile.jpg" width="319" height="235" alt="" title="" style="border:0px;margin:0px;padding:0px;"></a>
							<br/><br/>
							<span style="color:#979797;font-size:15px;">Cо времени Вашего последнего посещения появилось новое сообщение.</span><br/>
							<a href="<?= $link2 ?>" style="font-size:17px;color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank"><?= $link2 ?></a><br/><br/>
							<span style="color:#979797;font-size:14px;">Перейти по ссылке, чтобы прочитать поступившие ответы;<br/>новые уведомления не будут приходить, пока вы не просмотрите тему.</span><br/><br/>
							<a href="http://www.maryjane.ru/unsubscribe/%userId%/%unsubscribeCode%/blog/<?= $post_id ?>/" style="font-size:15px;color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">Отказаться от уведомлений о новых комментариях к этому посту</a><br/>
							<span style="color:#979797;font-size:15px;">Или отписаться от всех уведомлений в разделе "Профиль",<br/>нажав ссылку "<a href="%quickLoginLink%&next=http://www.maryjane.ru/profile/" style="font-size:15px;color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">Редактировать данные...</a>". </span>							
						</td>
					</tr>
				</tbody>
			</table>
