        ...
        <table border="0" cellpadding="0" cellspacing="0" width="645" style="margin:0;">
            <tbody>
                <tr>
                 ...
                 <tr>
                     <td colspan="2">
                        <div style="margin:24px 0 0px 20px;padding: 5px 0 5px 5px;width: 90%;border:2px solid #F3F3F3;">
                            <table>
                                <tr>
                                    <td valign="top">
                                    ...
                                    <td width="10">&nbsp;</td>
                                    <td valign="top">
                                        <span style="padding: 3px 0;font-size: 14px;line-height: 19px;">Мы работает над  нашим сервисом и будем бесконечно признательны, если Вы поможете нам в этом. Написание отзыва займет 3 минуты, а в знак благодарности, мы отправим 200 рублей на Ваш телефон <?= $phone ?>, в течении 3-х дней (обязательно укажите номер заказа).</span>
                                    </td>
                                </tr>
                            </table> 
                        </div>
                ...
                <tr>
                    ...
                    <div style="margin:0px 0 0px 15px;font-size: 14px;">
                        1. Скорость обработки заказа<br/>     
                        2. Скорость и качество доставки<br/>     
                        3. Общение<br/>     
                        4. Соответствие товара описанию<br/>     
                        5. Купили бы снова?<br/>     
                        Будет здорово, если вы дополните отзыв — это поможет другим<br /> покупателям узнать о магазине больше
                    </div>
                    <br/> 
                    ...
                    <br/><br/>  
                    <span style="font-size: 14px;"><b>Спасибо</b> за заказ. Для нас, действительно важно качество. Поэтому, мы предоставляем <b>365 дней гарантии</b> и <a href="http://www.maryjane.ru/faq/group/10/" style="border:0px;margin:0px;padding:0px;color:#FF0000;" target="_blank">удобную возможность обмена и возврата</a>.</span>
                    <br/><br/>
                    <span style="font-size:14px;">Забыли логин или пароль?<br/>
                        <a href="/registration/recover/#%userEmail%">Нажмите здесь</a>, на Ваш еmail будут высланы регистрационные данные
                    </span>
                    <br/><br/><br/><br/>
