Способ оплаты Вашего заказа #<b><a href="http://www.maryjane.ru/orderhistory/<?= $order->id ?>/#o<?= $order->id ?>"><?= $orderPhoneNumber ?></a></b> был изменён с "<b><?= $from ?></b>" на "<b><?= $to ?></b>".
<br /><br />

<h1><?= $info ?></h1>
<br />
<b>Инструкция по оплате:</b><br />
<?= $text ?>

<p><b>Вы можете оплатить заказ наличными при получении заказа!</b></p><br />
<br />
<hr size="1">
