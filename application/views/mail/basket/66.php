...
<tr>
    <td>
        Здравствуйте, %userLogin%, %userName%!<br />
        <br />
        <br />
        В связи с отсутствием подтверждения оплаты (в течении 3-х рабочих дней) Ваш заказ <a href="%quickLoginLink%&next=http://www.maryjane.ru/orderhistory/<?= $orderNumber ?>/#<?= $orderNumber ?>/"><?= $orderPhoneNumber ?></a> аннулирован!<br />
        Если заказ является для Вас актуальным, пожалуйста сообщите нам. Если вы оплатили заказ, пожалуйста сообщите нам немедленно.<br />
        <br />
