            ...
            <tbody>
                ...
                <td align="left" style="color:#4a4a4a;">
                    ...
                    <span style="font-size:14px;">
						На вашем бонусном счету <?= $bonus ?> рубля(ей). <br>
						К сожалению уже 3 месяца вы ими не пользовались<br> и через 24 часа, они будут списаны.<br><br> 
                    </span>
                    
					<a href="%quickLoginLink%&next=http://www.maryjane.ru/catalog/" style="color:#2f98ce;font-size:18px;line-height:20px" target="_blank">Чтобы бонусы не сгорели, их нужно потратить <br/>в течении 24 часов.</a><br/><br/>
