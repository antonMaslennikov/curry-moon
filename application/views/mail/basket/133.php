<div style="width:681px;background-color:#cccccc;padding:0px;margin:0px;font-family:arial;font-size:13px;">
	...
	<div style="background-color:#ffffff;margin:0px 20px;padding:0px 33px 15px 33px;">
		...
		<span style="color:#4f4f4f;font-size:198x;">Спешим сообщить Вам, что Ваш заказ <a href="http://www.maryjane.ru/orderhistory/<?= $order->id ?>/" style="border:0;margin:0;padding:0;color:#3697da;" target="_blank"><?= $order->shortNumber ?></a> доставлен на почту.</span>			
		<br/><br/>							
		<a href="http://www.maryjane.ru/orderhistory/<?= $order->id ?>/" style="border:0;margin:0;padding:0;" target="_blank"><img src="http://www.maryjane.ru/images/mt/133/po4ta2.jpg" width="575" height="116" alt="" title="" style="border:0;margin:0;padding:0;"></a>
		<br/><br/>
		<span style="color:#979797;font-size:17px;">Если в течении двух недель вам не пришло почтовое извещение, то<br/> свяжитесь с вашим почтовым отделением, указав следующий код:<br/> <strong style="color:#4f4f4f;font-weight: bold;"><?= $code ?></strong></span>
		<br/><br/><br/>
		<span style="color:#4f4f4f;font-size:15px;">Уважаемые покупатели! Памятка для получения товара на почте.</span>
		<br/><br/>
		<span style="color:#979797;font-size:15px;">—&nbsp;Вскрывая посылку в отделении почты, сверьте содержимое с вложенной в<br/>&nbsp;&nbsp;&nbsp;&nbsp;посылку описью.</span><br/><br/>
		<span style="color:#979797;font-size:15px;">—&nbsp;Если содержимое посылки не соответствует вложенной описи, обращайтесь к<br/>&nbsp;&nbsp;&nbsp;&nbsp;администрации почты, для составления акта о несоответствии.</span><br/><br/>
		...
		<div style="font-size:14px;font-family:arial;color:#8b8b8b;margin-top:20px;">
				...
				<table cellpadding="0" width="100%" cellspacing="0" style="margin:0px;">
					<tbody><tr>
						<td width="60" rowspan="2" align="left">
							<a href="http://www.maryjane.ru/catalog/<?= $a['user_login'] ?>" style="border:0;margin:0;padding:0;" title="<?= $a['user_login'] ?>">
						...
						<td align="left" style="font-size:20px;color:#6b6b6b;">
							<a href="http://www.maryjane.ru/catalog/<?= $a['user_login'] ?>" style="border:0;margin:0;padding:0;color:#6b6b6b;text-decoration: none;" title="<?= $a['user_login'] ?>"><?= $a['user_login'] ?></a>
					...
					<tr>
						<td align="left" colspan="2" style="padding-top: 12px;">
							<a href="http://www.maryjane.ru/catalog/<?= $a['user_login'] ?>" style="font-size:14px;border:0;margin:0;padding:0;color:#8b8b8b;font-style: italic;">Оставить автору отзыв</a>
						</td> 
					</tr>
				</tbody></table>
				<br/>
			...
			<table width="575" border="0" cellpadding="0" cellspacing="0">
				<tbody>
					<tr>
						<td align="left">
							<a href="http://www.maryjane.ru/bonuses/" style="border:0;margin:0;padding:0;" title="">
								<img src="http://www.maryjane.ru/images/mt/259/0<? if ($buyerDiscount == 0) echo 'a' ?>.png" width="54" height="67" alt="0%" title="0%" style="border:0;margin:0;padding:0;vertical-align:middle" />
							</a>
						</td>
						<td align="left">
							<a href="http://www.maryjane.ru/bonuses/" style="border:0;margin:0;padding:0;" title="">
								<img src="http://www.maryjane.ru/images/mt/259/5<? if ($buyerDiscount == 5) echo 'a' ?>.png" width="54" height="67" alt="5%" title="5%" style="border:0;margin:0;padding:0;vertical-align:middle" />
							</a>
						</td>
						<td align="left">
							<a href="http://www.maryjane.ru/bonuses/" style="border:0;margin:0;padding:0;" title="">
								<img src="http://www.maryjane.ru/images/mt/259/7<? if ($buyerDiscount == 7) echo 'a' ?>.png" width="54" height="67" alt="7%" title="7%" style="border:0;margin:0;padding:0;vertical-align:middle" />
							</a>
						</td>
						<td align="left">
							<a href="http://www.maryjane.ru/bonuses/" style="border:0;margin:0;padding:0;" title="">
								<img src="http://www.maryjane.ru/images/mt/259/9<? if ($buyerDiscount == 9) echo 'a' ?>.png" width="54" height="67" alt="9%" title="9%" style="border:0;margin:0;padding:0;vertical-align:middle" />
							</a>
						</td>
						<td align="left">
							<a href="http://www.maryjane.ru/bonuses/" style="border:0;margin:0;padding:0;" title="">
								<img src="http://www.maryjane.ru/images/mt/259/10<? if ($buyerDiscount == 10) echo 'a' ?>.png" width="54" height="67" alt="10%" title="10%" style="border:0;margin:0;padding:0;vertical-align:middle" />
							</a>
						</td>
						<td align="left">
							<a href="http://www.maryjane.ru/bonuses/" style="border:0;margin:0;padding:0;" title="">
								<img src="http://www.maryjane.ru/images/mt/259/15<? if ($buyerDiscount >= 15) echo 'a' ?>.png" width="54" height="67" alt="15%" title="15%" style="border:0;margin:0;padding:0;vertical-align:middle" />
							</a>
						</td>
					</tr>
				</tbody>
