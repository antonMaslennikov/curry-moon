            ...
            <tbody>
                ...
                <td align="left" style="color:#4a4a4a;">
                    ...
                    <span style="font-size:14px;">
                        Воспользуйтесь деньгами в течении 24 часов, до <?= $dayX ?> 13:00,<br> превратив их в футболку, толстовку, свитшот, чехол,<br>постер или дизайнерскую наклейку.<br><br>
                    </span>       
                    ...
                    <br/><br/>
                    <a href="<?= $link ?>" style="font-size:18px;border:0;margin:0;padding:0;color:#3594ff;" target="_blank">Написать отзыв</a>
                    <br/><br/><br/><br/>
