		...
		<tbody>
			<tr>
				<td align="left" style="padding-left:26px;">
					<div style="color:#4a4a4a;font-size:11px;height:15px;white-space: nowrap;">Совсем недавно вы купили <?= $style_name ?> "<?= $position['good_name'] ?>"</div>
				</td>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="645" style="margin:0;">
			<tbody>
				...
				<td align="left" style="color:#4a4a4a;">
					<br/>
					<span style="font-size: 18px;line-height: 19px;">Здравствуйте, %userNameLogin%</span>
					<br/><br/><br/>	

					<span style="font-size: 14px;">Меня зовут Сергей, я - руководитель проекта Maryjane.ru. Вчера вы<br/> купили <?= $position['style_name'] ?> "<?= $position['good_name'] ?>" автор - <a href="http://www.maryjane.ru/catalog/<?= $position['user_login'] ?>/"><?= $position['user_login'] ?></a>. <? if ($bonusBack): ?><br/><br/>Через 14 дней мы начислим вам <?= $bonusBack ?> рубля(ей) на Ваш счет.<? endif; ?></span>	
					<br/><br/>	
					<span style="font-size: 14px;">Как вы уже поняли, я хотела сказать <b>спасибо</b> за то, <b>что вы купили у<br/>нас</b>. Для меня действительно важно качество товаров, на которые мы<br/>предоставляем <b>365 дней гарантии</b> и <a href="http://www.maryjane.ru/faq/group/10/" style="border:0px;margin:0px;padding:0px;color:#FF0000;" target="_blank">удобную возможность обмена и возврата</a>, а так же качество нашего сервиса. </span>
					<br/><br/>	
					
					<span style="font-size: 16px;">Искренне надеюсь что вам  понравилось покупать у нас!</span>					
					<br/>
					<div style="margin:24px 0 0px 0px;padding: 5px 0 5px 5px;width: 366px;border:2px solid #F3F3F3;">
						<div style="float:left;margin: 10px 10px 0 6px;">
							<a href="#" style="border:0px;margin:0px;padding:0px;" target="_blank"><img src="http://www.maryjane.ru/images/order/mj/400/heart.jpg" width="50" height="47" alt="" title="" style="border:0px;margin:0px;padding:0px;" /></a>
						</div>
					...
					<div style="margin:0px 0 0px 15px;font-size: 14px;">
						1. Вы легко нашли нужный товар на сайте?<br/>     
					    2. Было ли просто оформить заказ? <br/>     
						3. Был ли вежлив менеджер, курьер? <br/>     
						4. Курьер приехал вовремя?  <br/>    
					...
					<br/><br/>
					<a href="http://www.maryjane.ru/contact_us/?order=<?= $order->id ?>" style="font-size:18px;border:0px;margin:0px;padding:0px;color:#3594ff;" target="_blank">Написать отзыв</a>
					<br/><br/>
					<span style="font-size:14px;">Забыли логин или пароль?<br/>
                        <a href="/registration/recover/#%userEmail%">Нажмите здесь</a>, на Ваш еmail будут высланы регистрационные данные</span>
					<br/><br/><br/><br/>
						...
						<tbody>
							<tr>
								<td align="center" width="106">			
									<!--img src="http://www.maryjane.ru/images/mt/lera.jpg" width="106" height="106" alt="Валерия Матросова" title="Валерия Матросова" style="border:0px;margin:0px;padding:0px;" /-->
								</td>
								<td width="25">&nbsp;</td>
								<td align="left" valign="top" style="padding-top:7px;font-size:16px;line-height: 19px;">	
									С уважением,<br/>Сергей Родин<br/>Руководитель проекта 
								</td>
							</tr>
						</tbody>
					</table>
