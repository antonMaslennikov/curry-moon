            ...
            <tbody>
                ...
                <td align="left" style="color:#4a4a4a;">
                    ...
                    <span style="font-size:14px;">
                        Воспользуйтесь деньгами в течении 24 часов, до <?= $dayX ?> 23:59,<br> превратив их в футболку, толстовку, свитшот, чехол,<br>постер или дизайнерскую наклейку.<br><br>
                        Вы можете  <a href="<?= $link ?>" style="color:#3594ff;" target="_blank">оставить отзыв</a> и <b>пролонгировать бонусы еще на 2 месяца</b>!
                        <? if (!$us): ?>
                        <p style="color:red">При написании отзыва обязательно укажите свой логин на нашем сайте,<br> иначе блокировка бонусов будет не возможна!</p>
                        <? endif; ?> 
                    ...
                    <br/><br/>
                    <a href="%quickLoginLink%&next=http://www.maryjane.ru/contact_us/" style="font-size:18px;border:0;margin:0;padding:0;color:#3594ff;" target="_blank">Написать отзыв</a>
                    <br/><br/><br/><br/>
