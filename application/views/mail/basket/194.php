<div style="width:681px;background-color:#cccccc;padding:0px;margin:0px;font-family:arial;font-size:13px;">
			...
			<tbody>
				<tr>
					...
					<td align="left">
						...
						<br/><br/>
						<span style="color:#4f4f4f;font-size:19px;">К сожалению, нам не удается связаться с Вами<br/>по указанным при оформлении заказа номерам:<br/>+<?= $user_tel ?>, по причине того, что набранный<br/>номер <?= $phonecallStatus ?>.</span>			
						<br/><br/>							
						<a href="#" style="border:0px;margin:0px;padding:0px;" target="_blank"><img src="http://www.maryjane.ru/images/mt/194/ne_dozvon.jpg" width="317" height="233" alt="" title="" style="border:0px;margin:0px;padding:0px;"></a>
						<br/><br/>
						<span style="color:#979797;font-size:17px;">Мы будем продолжать дозваниваться Вам.<br/>Одновременно, в целях  ускорения доставки заказа,<br/>просим Вас перезвонить нам +7 (495) 229-30-73</span>
						<br/><br/>
						<span style="color:#979797;font-size:17px;">С уважением,<br/> Курьерская служба <a href="http://www.maryjane.ru" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">maryjane.ru</a></span>	
						<br/><br/>
						<span style="color:#979797;font-size:12px;">На вашем счету: <a href="http://www.maryjane.ru/bonuses/" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">%userBonusesCount% руб.</a></br>Посмотреть историю всех заказов <a href="http://www.maryjane.ru/orderhistory/" style="color:#3697da;border:0px;margin:0px;padding:0px;" target="_blank">здесь.</a></span>
					</td>
				</tr>
			</tbody>
		</table>
	...
	<div style="width:100%;margin:0;padding:30px 0 0 0;">
		...
		<div align="left" style="padding-left:30px;">
			...
			<br/>
			<div style="color:#666;max-width:610px;text-align:justify;">«Для нас дизайн-это нечто большее чем просто красивая форма.Ты можешь рисовать и стать автором, а можешь быть наблюдателем. Неважно какой именно путь ты выбрал в любом случае изобразительное искусство - это только начало знакомства с самим собой.»</div>
			<br/>
