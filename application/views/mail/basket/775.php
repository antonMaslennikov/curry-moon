            ...
            <tbody>
                ...
                <td align="left" style="color:#4a4a4a;">
                    ...
                    <span style="font-size:14px;">
                        У вас была возможность оценить товар, пожалуйста напишите все ли вам понравилось.<br />
                        Если вы оставляли отзыв в прошлый раз, просим прощения за беспокойство</span>       
                    ...
                    <br/><br/>
                    <a href="http://www.maryjane.ru/contact_us/<? if ($order): ?>?order=<?= $order ?><? endif; ?>" style="font-size:18px;border:0;margin:0;padding:0;color:#3594ff;" target="_blank">Написать отзыв</a>
                    <br/><br/><br/><br/>
