<div style="width:681px;background-color:#cccccc;padding:0px;margin:0px;font-family:arial;font-size:13px;">
	...
	<div style="background-color:#ffffff;margin:0px 20px;padding:0px 0px 15px 33px;">
		<div style="width:100%;">
			<a href="http://www.maryjane.ru" style="border:0px;margin:0px;padding:0px;"><img src="http://www.maryjane.ru/images/order/mj/329/logo.gif" alt="maryjane" title="maryjane.ru" style="border:0px;margin:0px;padding:0px;" /></a>
			<span style="padding-left:15px;font-size:18px;font-family:arial;color:#a5a5a5;">Вам начислены деньги</span>
		</div>
		<br/><br/>
		<a href="http://maryjane.ru/promo/" style="border:0px;margin:0px;padding:0px;" target="_blank"><img src="http://www.maryjane.ru/images/mt/569/bonus2.jpg" width="580" height="117" alt="Получи 20% с продаж" title="Получи 20% с продаж - использую промо ссылку" style="border:0px;margin:0px;padding:0px;"></a>	
		<br/><br/>
		<div style="padding-left:73px">				
			<h4 style="margin:17px 0px 7px 0px;font-size:16px;font-family:arial;color:#4a4a4a;">Здравствуйте, %userNameLogin%!</h4>
			
			<? 
				$shortUrl = new shortUrl; 
				$shortCode=  $shortUrl->urlToShortCode('http://www.maryjane.ru/informers/' . $informer->informer_key . '/'); 
			?>
			
			<div style="color:#4a4a4a;font-size:15px;line-height:19px;">Заказ, оформленный после перехода по Вашей промо-ссылке <a rel="nofollow" href="http://www.maryjane.ru/promo/<?= $shortCode ?>/" style="border:0px;margin:0px;padding:0px;color:#4a4a4a;text-decoration:none;cursor:default;">http://www.maryjane.ru/promo/<?= $shortCode ?>/</a>,
				<? if ($informer->informer_comment): ?>
				<br />(<?= $informer->informer_comment ?>)
				<? endif; ?>
				<br/>перешел в статус “Доставлен”.<br/>На Ваш счет начислено <?= $pay ?>руб. <a href="%quickLoginLink%&next=http://www.maryjane.ru/stat/promo/" style="font-size:15px;border:0px;margin:0px;padding:0px;color:#2f98cd'" target="_blank">Подробнее тут.</a></div>
			<br/><br/>			
		</div>
		<br/><br/>
	</div>
