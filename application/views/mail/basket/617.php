		...
		<tbody>
			<tr>
				<td align="left" style="padding-left:26px;">
					<div style="color:#4a4a4a;font-size:11px;height:15px;white-space: nowrap;">Совсем недавно вы купили <?= $style_name ?> "<?= $position['good_name'] ?>", вам выплачено <?= $bonus ?> рубля(ей),на Ваш <a href="http://www.maryjane.ru/bonuses/" style="border:0;margin:0;padding:0;color:#4a4a4a;" target="_blank">бонусный счет</a></div>
				</td>
			</tr>
		</tbody>
	</table>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="645" style="margin:0;">
			<tbody>
				<tr>
					...
					<a href="%quickLoginLink%&next=http://www.maryjane.ru" style="border:0;margin:0;padding:0;" target="_blank"><img src="http://www.maryjane.ru/images/mt/logo2013.jpg" width="70" height="80" alt="" title="" style="border:0;margin:0;padding:0;" /></a>
				</td>
				<td align="left" style="color:#4a4a4a;">
					<br/>
					<span style="font-size: 18px;line-height: 19px;">Здравствуйте, %userNameLogin%,<br/><b>совсем недавно вы купили</b> <br/><?= $position['style_name'] ?> "<?= $position['good_name'] ?>"</span>
					<br/>
					<span style="font-size:14px;font-style:italic;">
					Вам выплачено <?= $bonus ?> рубля(ей), на Ваш <a href="http://www.maryjane.ru/bonuses/" style="border:0;margin:0;padding:0;color:#4a4a4a" target="_blank">бонусный счет</a></span>
					<hr color="#F3F3F3" size="2" width="366" style="margin:10px 0 20px">					
					<span style="font-size:18px">Понравилось ли вам покупать в нашем магазине?</span>					
					<br/>
					<div style="margin:24px 0 0px 0px;padding: 5px 0 5px 5px;width: 366px;border:2px solid #F3F3F3;">
						<div style="float:left;margin: 10px 10px 0 6px;">
							<a href="#" style="border:0;margin:0;padding:0;" target="_blank"><img src="http://www.maryjane.ru/images/order/mj/400/heart.jpg" width="50" height="47" alt="" title="" style="border:0;margin:0;padding:0;" /></a>
						</div>
						<div style="float:left;margin: 5px 0px 5px 9px;">
							<span style="padding: 3px 0;font-size: 14px;line-height: 19px;">&nbsp;Мы постоянно улучшаем наш сервис&nbsp;<br/>&nbsp;и будем бесконечно признательны,&nbsp;<br/>&nbsp;если Вы поможете нам в этом.&nbsp;</span>
						</div>
						<div style="clear:left;"></div>	
					</div>
					<br/>
					<span style="font-size: 14px;line-height: 19px;">Вам все понравилось -  нам будет приятно услышать об этом. Если<br/> что-то не понравилось - нам очень важно знать что именно.<br/>Напишите: </span>
					<br/><br/>					
					<div style="margin:0px 0 0px 15px;font-size: 14px;">
						1. Вы также довольны товаром?<br/>     
					    2. Если есть претензии скажите нам о них.<br/>     
						3. Нужен ли обмен/возврат? (у вас еще 11 месяцев чтобы передумать)<br/>     
						4. Не возникло ли проблем в ходе эксплуатации?
					</div>
					<br/> 
						
					<span style="font-size:14px;">Написание отзыва займет <b>3 минуты</b>.</span>
					<br/><br/>
					<a href="http://www.maryjane.ru/contact_us/?order=<?= $order->id ?>" style="font-size:18px;border:0;margin:0;padding:0;color:#3594ff;" target="_blank">Написать отзыв</a>
					<br/><br/><br/><br/>
					
					<table width="" border="0" cellpadding="0" cellspacing="0" style="margin:0;">
						<tbody>
							<tr>
								<td align="center" width="106">			
									<img src="http://www.maryjane.ru/images/mt/lera.jpg" width="106" height="106" alt="Валерия Матросова" title="Валерия Матросова" style="border:0;margin:0;padding:0;" />
								</td>
								<td width="25">&nbsp;</td>
