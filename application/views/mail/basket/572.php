<div style="width:681px;background-color:#cccccc;padding:0px;margin:0px;font-family:arial;font-size:13px;">
		...
		<tbody>
			<tr>
				<td align="left" style="padding-left:26px;">
					<div style="color:#666;font-size:12px;height:15px;max-width: 210px;white-space: nowrap;">Вам скидка 10%! Дооформите заказ сегодня!</div>
				</td>
	...
	<div style="background-color:#ffffff;margin:0px 20px;padding:0px 0px 15px 33px;">
		<div style="width:100%;">
			<a href="http://www.maryjane.ru" style="border:0px;margin:0px;padding:0px;"><img src="http://www.maryjane.ru/images/order/mj/329/logo.gif" width="55" height="55" alt="maryjane" title="maryjane.ru" style="border:0px;margin:0px;padding:0px;" /></a>
		</div>
			...
			<tbody>
				<tr>
					...
					<td align="left" valign="top">
						<div style="font-size:18px;font-family:arial;color:#4a4a4a;">Мы предоставляем Вам<br/>скидку 10% - закажите сейчас.<br/>Ваша корзина с товаром ждет.</div>
						<br/><br/>
		...
		<a href="http://www.maryjane.ru<?= $link; ?>" style="font-size:16px;border:0px;margin:0px;padding:0px;color:#2f98cd;word-wrap:break-word;" target="_blank">http://www.maryjane.ru<?= $link; ?></a>
		<br/><br/><br/>
		...
		<table cellpadding="0" cellspacing="0" style="margin-top: 10px;padding-bottom: 6px;margin-bottom:15px;width:94%;border-bottom:1px solid silver;border-top:1px solid silver;font-size:14px;font-family:arial;color:#8b8b8b;">
				...
				<tr>
					<td width="90" valign="top">
						...
						<? else: ?>
							<a href="http://www.maryjane.ru/customize/style,<?= $g['style_id'] ?>/<?= $g['good_id'] ?>/">
								<img src="<?= $g['imagePath'] ?>" style="max-width: 85px" />
							</a>
							<? if ($g['imageBackPath']): ?>
								<a href="http://www.maryjane.ru/catalog/<?= $g['user_login'] ?>/<?= $g['good_id'] ?>/">
					...
					<td style="width:40px;height: 30px;" align="center"><?= ($g['discount'] + $discount) ?></td>				
					<td style="width:40px;height: 30px;" align="center"><?= $g['quantity'] ?></td>
					<td style="width:50px;height: 30px;" align="center"><?= round($g['tprice'] - ($g['tprice'] / 100 * ($g['discount'] + $discount))) ?>&nbsp;руб.</td>
				</tr>
				<tr>
					<td colspan="7">&nbsp;</td>
				</tr>
