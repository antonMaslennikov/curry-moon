                        ...
                        <div style="margin:24px 0 0px 20px;padding: 5px 0 5px 5px;width: 90%;border:2px solid #F3F3F3;">
                            <table>
                                <tr>
                                    ...
                                    <td width="10">&nbsp;</td>
                                    <td valign="top">
                                        <span style="padding: 3px 0;font-size: 14px;line-height: 19px;">Мы работает над  нашим сервисом и будем бесконечно признательны, если Вы поможете нам в этом. Написание отзыва займет 3 минуты.</span>
                                    </td>
                                </tr>
                            </table> 
                        </div>
