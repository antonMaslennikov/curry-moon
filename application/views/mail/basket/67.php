<table width="740" cellpadding="20" cellspacing="0">

       	   <tr>

            <td>
            <p>Здравствуйте, %userLogin%, %userName%! <br />
  <br />
  К сожалению мы не можем выполнить Ваш заказ, возможно товар закончился на складе приносим извинения за неудобства.
  <br />
  Ваш заказ был аннулирован. <br />
  <br />
  В том случае, если Вы уже оплатили заказ, то деньги будут начислены на Ваш <a href="http://www.maryjane.ru/bonuses/">бонусный счет</a>.<br/>
  Подробно о бонусной системе читайте <a href="http://www.maryjane.ru/faq/#mjbonus">тут</a>.<br />
  <br />
  Надеемся на скорейшее решение сложившейся ситуации.<br />
  Спасибо за понимание.<br />
  <br />
  Заказ номер: <?= $orderPhoneNumber ?> <br />
  Стоимость доставки: <?= $deliveryCost ?> <br />
  Сумма заказа: <?= $orderTotal ?> <br />
  Итого: <?= $total ?> </p>
<p style=" font-style: normal; font-size: 12px; font-variant: normal; font-weight: normal; line-height: 12px; font-family: Arial, Tahoma, Verdana, sans-serif;line-height: 18px;">На вашем счету: <a href="%quickLoginLink%&next=http://www.maryjane.ru/bonuses/" style="color: #6F6E6E;">%userBonusesCount%</a> руб.<br>
За этот заказ, Вам будет начислено %userBonusesWait% руб.<br>
Посмотреть историю всех  заказов <a href="%quickLoginLink%&next=http://www.maryjane.ru/orderhistory/" style="color: #6F6E6E;">здесь</a>.</p>
	...
	<tr>
	  ...
	  <td colspan="3" style="border-top-width: 1px; border-top-color: #444; border-top-style: solid; vertical-align: top;" valign="top">
		...
		<div style="height:0;line-height:5px;margin:0;padding:0;">&nbsp;</div>

			<br />					
			<div style="text-align:justify;font-size:12px;">«Для нас дизайн-это нечто большее чем просто красивая форма.Ты можешь рисовать и стать автором, а можешь быть наблюдателем. Неважно какой именно путь ты выбрал в любом случае изобразительное искусство - это только начало знакомства с самим собой.»</div>
								
			<p style="font-style:normal; font-size: 12px; font-variant: normal; font-weight: normal; line-height: 12px; font-family: Arial, Tahoma, Verdana, sans-serif;line-height: 18px; text-shadow: 1px 1px #fff;">&copy; <a href="%quickLoginLink%&next=http://www.maryjane.ru" style=" font-style: normal; font-size: 12px; font-variant: normal; font-weight: normal; line-height: 12px; font-family: Arial, Tahoma, Verdana, sans-serif;color:#555; text-shadow:none;">Магазин футболок №1 Maryjane.ru</a></p>
