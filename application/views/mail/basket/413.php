			...
			<tbody>
				<tr>
					...
					<td align="left" valign="bottom" style="padding-bottom: 3px;">
						<span style="font-size:18px;font-family:arial;color:#a5a5a5;">Ваш заказ доставлен в курьерскую службу</span>
					</td>
				</tr>
			</tbody>
		</table>
		<h4 style="margin:17px 0px 7px 0px;font-size:18px;font-family:arial;color:#4a4a4a;">Здравствуйте, %userNameLogin%!</h4>
		<span style="color:#4f4f4f;font-size:18px;">Ваш заказ передан в службу доставки "im-logistics". В скором времени ваша посылка будет в пункте самовывоза. <br/><a href="http://maps.yandex.ru/?text=<?= $maplink ?>">Посмотреть на карте</a>.</span>			
		<br/><br/>							
		<img src="http://www.maryjane.ru/images/mt/398/logistics2.jpg" width="575" height="116" alt="" title="" style="border:0px;margin:0px;padding:0px;">
		<br/><br/>
		<span style="color:#979797;font-size:17px;">О доставке заказа в пункт самовывоза Вам придёт смс.</span>
		<br/>
		<span style="color:#979797;font-size:17px;">Ориентировочная дата прибытия (<?= $delivery_time ?>, начиная с этого момента).</span>
		<br/>
		<span style="color:#979797;font-size:17px;">Обратите внимание, что бесплатное хранение в пункте - <strong style="color:#4f4f4f;font-weight: bold;">7 дней</strong>.</span>
		<br/>
		<? if ($code): ?>
			<br/>
			<span style="color:#979797;font-size:17px;">Отследить Вашу посылку Вы можете здесь <a href="http://iml.ru/status">http://iml.ru/status</a>.<br/>Код отслеживания: <?= $code ?></span>
		<? endif; ?>
		<br/><br/>
