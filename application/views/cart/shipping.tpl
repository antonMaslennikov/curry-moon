<div id="ajaxshipping" style="min-height: 30px;">
    <div class="opc_ship_wrap opc_ship_wrap_1" id="opc_ship_wrap_1">
        <input type="radio" data-dynamic-update="1" name="shipmentmethod_id" id="shipment_id_1" value="post">
        <label for="shipment_id_1">
            <span class="vmshipment">
                ...
                <span class="vmshipment_cost fee">(Фиксированная стоимость: +400 руб)</span>
            </span>
        </label>
    </div><!-- opc_ship_wrap end -->
    <br>
    <div class="opc_ship_wrap opc_ship_wrap_2 selected" id="opc_ship_wrap_2">
        <input type="radio" data-dynamic-update="1" autocomplete="off" name="shipmentmethod_id" id="shipment_id_2" checked="checked" value="major">
    ...
    <div class="opc_ship_wrap opc_ship_wrap_6" id="opc_ship_wrap_6" {if $USER->user_country_id != 838}style="display:none"{/if}>
        <input type="radio" data-dynamic-update="1" name="shipmentmethod_id" id="shipment_id_6" value="user">
